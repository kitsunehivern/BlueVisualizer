...
namespace OptionBoxData {
    const sf::Vector2f optionBoxPosition = sf::Vector2f(0.f, 670.f);
    const float characterSize = 25.f;

    namespace Option {
        const float tableWidth = 180.f;
        const float tableHeight = 210.f;
        const sf::Vector2f tablePosition = sf::Vector2f(10.f, 10.f);
    ...
    namespace Suboption {
        ...
        const sf::Vector2f tablePosition = sf::Vector2f(210.f, 10.f);
    ...
    namespace Input {
        ...
        const sf::Vector2f tablePosition = sf::Vector2f(210.f, 80.f);
...
public:
    ...
    std::vector<std::string> handleEvent(sf::RenderWindow* window, sf::Event event);
